...
const schools = [
  { id: 'school-a', name: 'School A', x: 28.7, y: 67.9, color: '#3b82f6', polygon: [], polygons: [] },
  { id: 'school-b', name: 'School B', x: 32.5, y: 50.0, color: '#ef4444', polygon: [], polygons: [] },
  { id: 'school-c', name: 'School C', x: 35.0, y: 15.0, color: '#84cc16', polygon: [], polygons: [] },
] as any;
...
schools.forEach((school: any) => {
  ...
  console.log(`School ${school.id} assigned centers:`, assignedCenters.map((c: any) => c.id));
  console.log(`School ${school.id} final polygon:`, JSON.stringify(school.polygon));
});
